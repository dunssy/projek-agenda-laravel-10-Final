            ...
            @foreach ($data as $ajaran)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" onclick="confirmDelete({{$ajaran->id_ajaran}})" class="btn btn-danger btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '/delete/tahun_ajaran/' + id;
                }
            })
        }
        </script>
